...
const FLAGS: Record<string, React.ReactNode> = {
  ...
  gb: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 30"><rect width="60" height="30" fill="#012169"/><path d="M0,0L60,30M60,0L0,30" stroke="#fff" strokeWidth="6"/><path d="M0,0L60,30M60,0L0,30" stroke="#C8102E" strokeWidth="3"/><rect x="24" y="0" width="12" height="30" fill="#fff"/><rect x="0" y="11" width="60" height="8" fill="#fff"/><rect x="26" y="0" width="8" height="30" fill="#C8102E"/><rect x="0" y="12" width="60" height="6" fill="#C8102E"/></svg>,
  dz: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 20"><rect width="15" height="20" fill="#006233"/><rect x="15" width="15" height="20" fill="#fff"/><circle cx="17" cy="10" r="5" fill="#D21034"/><circle cx="18.5" cy="10" r="4" fill="#006233"/><path d="M15.5,6L16.6,9.2L13.2,7.1L17.8,7.1L14.4,9.2Z" fill="#D21034" transform="translate(1.5,1)"/></svg>,
