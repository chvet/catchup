...
export default function TypingIndicator() {
  return (
    <div className="flex items-start mb-2 msg-appear px-1" role="status" aria-label="L'assistant est en train d'\u00e9crire">
      {/* M\u00eame avatar que les bulles assistant */}
      ...
      <div className="bg-white rounded-2xl rounded-bl-md px-4 py-3 shadow-sm -mt-1">
